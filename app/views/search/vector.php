<section class="container-self mt-5 pt-4">
    <h3 class="mt-3 mb-1">View from Vectors</h3>
    ...
    <div class="w-100 d-flex align-items-center align-content-center ">
        ...
        <div class="overflow-auto d-inline-block ml-3">
            <?php foreach ($data['more'] as $more) : ?>
                <a href="<?= BASEURL; ?>/search/vector/<?= $more['img_category'] ?>" class="badge badge-secondary ml-2 p-2 pr-3 pl-3" style="font-size:12.5px"><?= $more['img_category'] ?></a>
            <?php endforeach; ?>
        </div>
    </div>
    <div class="my-grid active" data-tab="photos">
        ...
        <?php if (!is_null($data['list'])) : ?>
            <?php foreach ($data['list'] as $image) : ?>
                <div class="grid-item">
                            ...
                            <div class="image-detail-info">
                                ...
                                <div class="bottom-part">
                                    <div class="user_account custom">
                                        <a href="<?= BASEURL; ?>/member/user/<?= $image['id']; ?>" class="acnt">
        ...
        <?php if ($data['list'] == null) {
            echo  "This category is not exist in this type!!";
        } ?>
</section>
