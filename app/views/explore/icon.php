<header class="explore-tab-link">
	<div class="tab-link">
		...
		<a href="<?= BASEURL; ?>/explore/vector" class="">Vectors</a>
		<a href="<?= BASEURL; ?>/explore/icon" class="active-link">Icons</a>
	</div>
</header>
...
<section class="explore-section-part row justify-content-center">
	<div class="col-11 col-lg-10 col-md-11 col-sm-11">
		<header class="explore-section-header">
			<div class="head-name">
				<p>Icons Categories</p>
				<p>Find all Icons just by category </p>
			</div>
		</header>
		<article>
							...
							<div class="category-outer-wrapper">
								<div class="category-inner-wrapper">
									<div class="category-preview-holder">
										<div class="category-preview-wrapper">
											...
											<?php for ($i = 0; $i < 4; $i++) : ?>
												<?php $img = $category[$i] ?>
												<?php if ($i === 0) : ?>
													<div class="category-preview-image" style="background-image: url('<?= BASEURL; ?>/assets/upload/icon/small/<?= $img['img_file']; ?>');"></div>
													<div class="category-preview-image-2">
													<?php else : ?>
														<div class="sec-category-preview-image" style="background-image: url('<?= BASEURL; ?>/assets/upload/icon/small/<?= $img['img_file']; ?>');"></div>
													<?php endif; ?>



													<!-- <div class="sec-category-preview-image"
													style="background-image: url(<?= BASEURL; ?>/assets/upload/icon/small/<?= $img['img_file']; ?>);"></div>
												<div class="sec-category-preview-image"
													style="background-image: url(<?= BASEURL; ?>/assets/upload/icon/small/<?= $img['img_file']; ?>);"></div> -->
												<?php endfor; ?>
													</div>
									...
									<div class="category-caption">
										...
										<p><?= count($category); ?> Icons</p>
									</div>
									<a href="<?= BASEURL; ?>/search/icon/<?= $category[0]['img_category']; ?>" class="link-wrapper"></a>
								</div>
							</div>
						</li>
					<?php endif; ?>
