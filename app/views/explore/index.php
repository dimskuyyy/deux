<header class="explore-tab-link">
	<div class="tab-link">
		<a href="<?= BASEURL; ?>/explore/index" class="active-link">Photos</a>
						...
						<li class="col-12 col-lg-4 col-md-4 col-sm-6 ">
									...
									<div class="category-preview-holder">
										<div class="category-preview-wrapper">
											...
											<?php for ($i = 0; $i < 4; $i++) : ?>
												<?php $img = $category[$i] ?>
												<?php if ($i === 0) : ?>
													<div class="category-preview-image" style="background-image: url('<?= BASEURL; ?>/assets/upload/photo/small/<?= $img['img_file']; ?>')"></div>
													<div class="category-preview-image-2">
													<?php else : ?>
														<div class="sec-category-preview-image" style="background-image: url('<?= BASEURL; ?>/assets/upload/photo/small/<?= $img['img_file']; ?>')"></div>
													<?php endif; ?>
							...
							<div class="sec-category-preview-image"
								style="background-image: url(<?= BASEURL; ?>/assets/upload/photo/small/<?= $img['img_file']; ?>);"></div> -->
									...
									<a href="<?= BASEURL; ?>/search/photo/<?= $category[0]['img_category']; ?>" class="link-wrapper"></a>
								</div>
							</div>
						</li>
					<?php endif; ?>
