    <main class="jumbotron text-white">
        <div class="overlay_main_page"></div>
        <div class="row justify-content-center">
            <div class="col-md-6 main_page text-left mt-5 pt-5">
                <h1 class="display-4 head ml-0 mb-0">Deux</h1>
                <h4 class="mt-1 mb-4 ml-1">A website for free photos, vectors and icons</h4>
                <div class="search_dms w-100">
                    <form class="position-relative" id="second_search_link" action="<?= BASEURL; ?>/search/index" method="post">
                        <button class="srch_btn srch_btn_pro"><i class="search icon sh"></i><span>Search</span></button>
                        <input autocapitalize="none" type="search" class="srch w-100" placeholder="Search here" required="required" name="search" autocomplete="off" id="second_search" data-query="">
                        <div id="searchList"></div>

                        <div>
                            <h4 class="searching_ mt-3 ml-0">Search by : </h4>
                            <div class="row d-inline-block ml-1 mt-2">
                                <ul class="nav nav-pills filter_srch">
                                    <li class="item_actv">
                                        <input type="radio" name="search_by" value="photo" class="non-act actv" id="photo"></input>
                                        <label for="photo">Photos</label>
                                    </li>
                                    <li>
                                        <input type="radio" name="search_by" value="vector" class=" non-act" id="vector"></input>
                                        <label for="vector">Vectors</label>
                                    </li>
                                    <!-- <li>
									<input type="radio" name="search_by" value="icon" class=" non-act" id="icon"></input>
                                    <label for="icon">Icons</label>
								</!-->
                                    <span class="d-inline-block animate_btn"></span>
                                </ul>
                            </div>
                        </div>
                    </form>
    ...
    <section class="container-self">
        <h3 class="mt-3 mb-1">View from Photos and Vectors</h3>
        <h4 class="mt-0">Result from authors</h4>
                    ...
                    <div class="grid-content">
                        <a href="<?= BASEURL; ?>/preview/index/<?= $image['img_id']; ?>" data-id="<?= $image['img_id']; ?>" data-category="<?= $image['img_category']; ?>" data-type="<?= $image['img_type']; ?>" data-toggle="modal" data-target="#home_modal" id="preview_link">
                            <div class="image-content">
                                ...
                                <img loading="lazy" src="<?= BASEURL . '/assets/upload/' . $image['img_type'] . '/' . $size . '/' . $image['img_file']; ?>" alt="test">
                            </div>
                            ...
                            <div class="image-detail-info">
                                ...
                                <div class="bottom-part">
                                    <div class="user_account custom">
                                        <?php
                                        $oriname = $image['username'];
                                        $fakename = str_replace(' ', '-', $oriname);
                                        $fakename = strtolower($fakename);
                                        ?>
                                        <a href="<?= BASEURL; ?>/member/user/<?= $image['id']; ?>-<?= $fakename ?>" class="acnt">
                                ...
                                <div class="image-feature">
                                    ...
                                    <div class="like-copy-link" style="opacity:0;visibility:hidden">
                                        ...
                                        <div class="image-love">
                                            <svg class="love_button modal_love" width="22.53" height="19" data-id="" viewBox="0 0 20 17" fill="none" xmlns="http://www.w3.org/2000/svg">
